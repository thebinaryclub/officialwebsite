...
This hackathon will provide self-exposure to the students as well as will help for the better cause of society by providing solutions to real-life problems.
            </Text>
          </Text>
          <Text>
            <Heading py={'10px'} className="text-1">
